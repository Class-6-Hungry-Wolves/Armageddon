...
variable "region" {
  description = "Region where the syslog server will be deployed."default   = "Tokyo"
}
...
resource "aws_security_group" "syslog_server" {
  ...
  ingress {
    ...
    cidr_blocks = ["10.81.0.0/16", "10.82.0.0/16", "10.83.0.0/16", "10.84.0.0/16", "10.85.0.0/16", "10.86.0.0/16"]
  }
